...
do
    ...
    python train_self_supervised.py --dataset ogbn-arxiv --nlayers=2 --sgc=1 --lr_feat=0.01 --device=0  --lr_adj=0.01 --reduction_rate=${r}  --seed=1 --inner 10 --save=1 >> $file
done